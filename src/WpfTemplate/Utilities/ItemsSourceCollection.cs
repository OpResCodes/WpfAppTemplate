...
namespace WpfTemplate.Utilities
{
    ...
    public class ItemsSourceCollection<T> : ObservableCollection<T>
    {

        /// <summary> 
        /// Initializes a new instance 
        /// </summary> 
        public ItemsSourceCollection() : base() { }
        ...
        public ItemsSourceCollection(IEnumerable<T> collection) : base(collection) { }
